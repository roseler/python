...
root.title("jack n poy")

# List of players
list = ["bato","papel","gunting"]
...
def spin():
    ...
    if user_select.get() == "Bato":
        user_select_value = 0
        print(user_select_value)
    elif user_select.get() == "Papel":
        user_select_value = 1
        print(user_select_value)
...
user_select = ttk.Combobox(root,value=["Bato","Papel","Gunting"])
...
button = Button(root,text="bato bato pik!",font=("bell mt",10),command=spin)
button.pack()
